...
\newcommand{\defenseplace}{Forum des images, Paris} %Place of defense
...
\newcommand{\jurynameA}{Vanda Luengo}
\newcommand{\jurygenderA}{Mme} % M. or Mme. / Mrs.
\newcommand{\juryadressA}{UPMC}
...
\newcommand{\jurynameD}{Amel Bouzeghoub}
\newcommand{\jurygenderD}{Mme} % M. or Mme. / Mrs.
\newcommand{\juryadressD}{Télécom SudParis}
\newcommand{\jurygradeD}{Professeur associé}
...
\newcommand{\jurygradeF}{Professeur des universités}
