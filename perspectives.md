...
Nous nous sommes rendus compte que considérer un a priori dans le modèle DINA (par exemple, \og 86 % des apprenants ont pour état latent ``0010`` \fg) fournissait de moins bons résultats qu'un a priori uniforme. C'est une piste de recherche à explorer.
